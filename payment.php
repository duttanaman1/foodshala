...
if ($_POST['submit'] != null) {
    $custpay = $_POST['amount'];
    $custname = $_POST['custname'];
    $date = date("Y-m-d H:i:s");
    mysqli_query($con, "UPDATE orders set status='paid', datetime='$date' where custname='$custname' ");
    $success = true;
}
$msg = '';
?>
                ...
                <div class="col">
                    ...
                    <div id="success" class="success hidden">
                        ...
                        <p>
                            <?php if ($success) {
                            ?>
                                <button class="btn btn-success" onclick="window.open('viewcustomer.php','_self')">Confirm</button>
                            <?php
                            }
                            ?> </p> <?php
